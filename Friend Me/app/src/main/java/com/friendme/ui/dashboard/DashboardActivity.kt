package com.friendme.ui.dashboard
...
import kotlinx.android.synthetic.main.activity_content_dashboard.*
import kotlinx.android.synthetic.main.activity_dashboard.*

class DashboardActivity : AppCompatActivity(), LogoutContract.logoutAkunView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tabDashboard.setupWithViewPager(viewpagerDashboard)
        tabDashboard.setOnTabSelectedListener(object : TabLayout.OnTabSelectedListener {
            override fun onTabSelected(tab: TabLayout.Tab) {
                viewpagerDashboard.setCurrentItem(tab.position)
            }
    ...
    class Viewpager(fm: FragmentManager?, private val context: Context) :
        ...
        private val tabTitles = arrayOf("Home", "Feed", "Room", "Chat")
