...
class CustomProgressDialog {
    ...
    fun show(context: Context, title: CharSequence?): Dialog {
        ...
        // Progress Bar Color
        setColorFilter(view.cp_pbar.indeterminateDrawable, ResourcesCompat.getColor(context.resources, R.color.black, null))
    ...
    class CustomDialog(context: Context) : Dialog(context, R.style.CustomDialogTheme) {
        init {
            ...
            window?.decorView?.rootView?.setBackgroundResource(R.color.grey_transparent_20)
